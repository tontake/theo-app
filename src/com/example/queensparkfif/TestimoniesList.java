...
public class TestimoniesList extends Activity{
	 ListView lv1;
		...
		//lv1.setAdapter(theann);
		 ...
		 lv1.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
						int arg2, long arg3) {
					// TODO Auto-generated method stub
					Intent i=new Intent(TestimoniesList.this,TestimoniesView.class);
		    ...
		    ed.addTextChangedListener(new TextWatcher(){
				...
				public void onTextChanged(CharSequence arg0, int arg1, int arg2,
						int arg3) {
					// TODO Auto-generated method stub
					TestimoniesList.this.annou.getFilter().filter(arg0);
	...
	public class ReadJson extends AsyncTask<String,Void,String>{
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			try{
				 pDialog = new ProgressDialog(TestimoniesList.this);
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				annou=new ArrayAdapter(TestimoniesList.this,android.R.layout.simple_list_item_1,products);
